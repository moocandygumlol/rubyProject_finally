...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference("Market.count") do
      post markets_url, params: { market: { item_id: @market.item_id, price: @market.price, quantity: @market.quantity, user_id: @market.user_id } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { item_id: @market.item_id, price: @market.price, quantity: @market.quantity, user_id: @market.user_id } }
